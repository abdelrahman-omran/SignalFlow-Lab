results_path = r"D:\GItHub Reops\DSP-tasks\results\task3\quantized-result.txt"
...
if __name__ == "__main__":
    ...
    Your_EncodedValues, Your_QuantizedValues = ReadSignalFile(results_path)
    QuantizationTest1("./Quan1_Out.txt", Your_EncodedValues, Your_QuantizedValues)
